...
public class Cuboid {
    ...
    public static class Repository {
        ...
        private final String oneLocation;
        private final String secondLocation;

        public Repository(String oneLocation, String secondLocation) {
        ...
        public Cuboid toCuboid() {
            return new Cuboid(
                    LocationUtil.byString(oneLocation),
                    LocationUtil.byString(secondLocation)
            );
        }
    }
}
